...
public class BetaUpgradeManager : MonoBehaviour
{
    ...
    public void DisableFlagsAndMultiEtc() // BetaMissionで使用
    {
        GameManager.Instance.AlphaFactorPerClickDecreaser(1.1); // BetaUpgrade0の効果を打ち消す
        GameManager.Instance.AlphaFactorPerClickDecreaser(1.2); //BetaUpgrade1の効果を打ち消す
        GameManager.Instance.BetaFactorPerGainDecreaser(1.2); // BetaUpgrade2の効果を打ち消す
        GameManager.Instance.BetaFactorPerGainDecreaser(1.5); // BetaUpgrade3の効果を打ち消す
        GameManager.Instance.AlphaFactorPerClickDecreaser(3); // BetaUpgrade4の効果を打ち消す
