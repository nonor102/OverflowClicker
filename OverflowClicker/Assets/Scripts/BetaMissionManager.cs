...
public class BetaMissionManager : MonoBehaviour
{
    ...
    public void EnterOrExitBetaMission(int tryMissionID, bool enter) // 試練に挑戦する処理
    {
        if (enter) // 試練に挑戦するなら
        {
            ...
            {
                case 1:
                    GameManager.Instance.BetaFactorPerGainDecreaser(100); // クリックごとに得られるAFの獲得量を1%に制限
                    break;
                case 2:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    GameManager.Instance.AddAlphaFactorExp(0.1); // AF獲得指数を0.1に制限
                    break;
                case 10:
        ...
        else // 試練をやめるなら
        {
            ...
            switch (tryMissionID)
            {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    GameManager.Instance.AddAlphaFactorExp(10); // AF獲得指数をもとにもどす
                    break;
                case 10:
